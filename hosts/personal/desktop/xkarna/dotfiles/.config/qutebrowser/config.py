...
config.set(
    ...
    True,
    "file:///home/savolla/.local/share/qutebrowser/userscripts/*",
)
...
config.bind(
    "<Space>dp",
    "spawn --detach wkhtmltopdf {url} /home/savolla/resource/notes/org/roam/biblio/webpages/{title}.pdf"  # fixed username
)
