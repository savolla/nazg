...
#else
static const char *fonts[]               = { "IosevkaTerm NF:size=12:style=Regular" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "IosevkaTerm NF:size=12:style=Regular";

static char c000000[]                    = "#000000";

static char normfgcolor[]                = "#a89984";
static char normbgcolor[]                = "#282828";
static char normbordercolor[]            = "#282828"; /* invisible */
static char normfloatcolor[]             = "#282828"; /* invisible */

static char selfgcolor[]                 = "#282828";
static char selbgcolor[]                 = "#a89984";
static char selbordercolor[]             = "#a89984";
static char selfloatcolor[]              = "#a89984";
...
static char titleselbordercolor[]        = "#7c6f64";
static char titleselfloatcolor[]         = "#7c6f64";
...
static char tagsselbgcolor[]             = "#a89984";
static char tagsselbordercolor[]         = "#7c6f64";
static char tagsselfloatcolor[]          = "#7c6f64";

static char hidnormfgcolor[]             = "#504945";
static char hidselfgcolor[]              = "#7c6f64";
static char hidnormbgcolor[]             = "#282828";
static char hidselbgcolor[]              = "#282828";

static char urgfgcolor[]                 = "#282828";
...
static const char *const autostart[] = {
  ...
  /* "slstatus", NULL, */
  /* "periodic-random-wallpaper-switcher", NULL, */
  /* /\* "personal-website-periodic-update.sh", NULL, *\/ */
  /* "udiskie", NULL, */

  /* /\* terminal session *\/ */
  /* "st", "sh", "-c", "tmux-session-creator", NULL, */

  /* /\* qutebrowser *\/ */
  /* "qutebrowser", "--qt-flag", "ignore-gpu-blacklist", "--qt-flag", "enable-gpu-rasterization", "--qt-flag", "enable-native-gpu-memory-buffers", "--qt-flag", "num-raster-threads=4", NULL, */
...
const char *spcmd1[] = {"st", "-n", "spterm", "-g", "110x20", "sh", "-c", "tmux new -As scratch", NULL};
...
static const Rule rules[] = {
	...
	/* RULE(.class = "Gimp", .tags = 1 << 4) */
	/* RULE(.class = "Firefox", .tags = 1 << 7) */
	RULE(.class = "mpv", .isfloating = 1, .bw = 0)
	RULE(.class = "Gcolor3", .isfloating = 1)
	RULE(.class = "qutebrowser", .tags = 1 << 1) // qutebrowser should spawn on tag:2
  RULE(.class = "Conky", .tags = 1 << 0, .isfloating = 1)
  /* RULE(.class = "xwinwrap", .tags = ~0, .bw = 0, .isfloating = 1) // gif wallpapers */
  RULE(.class = "gcr-prompter", .bw = 0, .isfloating = 1) // pinentry-gnome3

	#if RENAMED_SCRATCHPADS_PATCH
	RULE(.instance = "spterm", .scratchkey = 's', .isfloating = 1)
	#elif SCRATCHPADS_PATCH
	RULE(.instance = "spterm", .tags = SPTAG(0), .bw = 0, .isfloating = 1)
	RULE(.instance = "Conky", .bw = 0 )
	#endif // SCRATCHPADS_PATCH
};
...
static const Key keys[] = {
    ...
    { MODKEY, XK_p, spawn, {.v = (const char*[]){"dmenu_run_history", NULL}} },
	...
	{ MODKEY|ControlMask,           XK_g,      setscratch,             {.ui = 0 } },
	{ MODKEY|ShiftMask,             XK_g,      removescratch,          {.ui = 0 } },
	...
	{ MODKEY,                       XK_h,          viewtoleft,             {0} }, // note keybinding conflict with focusdir
	{ MODKEY,                       XK_l,          viewtoright,            {0} }, // note keybinding conflict with focusdir
